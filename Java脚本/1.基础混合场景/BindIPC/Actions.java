...
public class Actions
{
	...
	private void ownedByOtherRequest(){
		...
		web.custom_request("ownedByOther_request",
    		"Method=GET",
		new String[]{
		    "URL=http://<UserManagePlatIP>:8080/sklcloud/app/device/<ID>/ownedByOther",
		    "TargetFrame=",
		    "Resource=0",
		    "Referer=",
		    xmlBody,
	...
	private void isLiveIPCRequest(){
		...
		web.custom_request("isLiveDevice.app_request",
    		"Method=GET",
		new String[]{
		    "URL=http://<UserManagePlatIP>:8080/sklcloud/app/device/<ID>/isLiveDevice.app",
		    "TargetFrame=",
		    "Resource=0",
		    "Referer=",
		    xmlBody,
