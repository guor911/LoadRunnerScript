...
{
/*
	web_reg_save_param("streamPort",
					   "LB=<streamPort>",
					   "RB=</streamPort>",
					   LAST);

	web_custom_request("Wowza",
		"URL=http://192.168.139.208:8086/skl-cloud/cloud/stream/control",
		"Method=POST",
		"TargetFrame=",
		"Resource=0",
		"Referer=",
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n"
	          ...
	          "</inputStream>\r\n"
	          "<streamSource>\r\n"
		      "<sourceServerIp>null</sourceServerIp>\r\n"
		      "<sourceServerType>1</sourceServerType>\r\n"
	          "</streamSource>\r\n"
              "</streamControl>\r\n",
		LAST);
  */
