# 1 "d:\\lr\\ipconline\\\\combined_IPConline.c"
...
# 1 "d:\\lr\\ipconline\\\\combined_IPConline.c" 2
...
# 2 "d:\\lr\\ipconline\\\\combined_IPConline.c" 2
...
# 3 "d:\\lr\\ipconline\\\\combined_IPConline.c" 2
...
Action()
{
	...
	web_custom_request("web_custom_request",
		"URL=http://192.168.139.213:8080/sklcloud/skl-cloud/cloud/ipcCommand/connect",
		"Method=GET",
		"TargetFrame=",
		"Resource=0",
		"Referer=",
		"Body=<ipc_command>\r\n"
			"<qId>ASDFGHJM</qId>\r\n"
			"<productModel>0201</productModel><connectStatus>0</connectStatus>\r\n"
			"</ipc_command>\r\n",
		"LAST");
	...
	lr_error_message(lr_eval_string("{NewParam}"));

	return 0;
}
# 4 "d:\\lr\\ipconline\\\\combined_IPConline.c" 2
...
# 5 "d:\\lr\\ipconline\\\\combined_IPConline.c" 2
